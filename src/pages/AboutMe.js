...
function AboutContents() {
  return (
    <div className="aboutWrapper">
      ...
      <p>
        Hi, my name is <strong>Mia Hsu</strong> (she/her)!
        ...
        well as crocheting and scrapbooking occasionally. I love discovering new{" "}
        ...
        K-Rap! I am also a plant mom, foodie, and bread lover ʕ•ᴥ•ʔ.
        <br />
